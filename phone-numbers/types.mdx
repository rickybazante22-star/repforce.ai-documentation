...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with RepForce.ai: dedicated numbers, SIP integration, and Caller ID"
---

RepForce.ai lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from RepForce.ai.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from RepForce.ai's AI.
