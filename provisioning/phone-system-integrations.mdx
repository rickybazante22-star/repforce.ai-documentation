...
icon: "phone-office"
description: "Learn how to integrate RepForce.ai with your existing PBX or VOIP infrastructure through SIP trunks"
---

For businesses with existing PBX or VOIP infrastructure, RepForce.ai can integrate through SIP trunks or direct connections:

## 1. SIP Trunk

- **How It Works**: You share your SIP credentials (server, username, password). RepForce.ai configures a trunk internally.
...
- If your PBX already handles call routing, pass the call to RepForce.ai only when certain conditions are met (like after IVR selection).
...
- Carrier charges from your PBX provider still apply, plus any RepForce.ai usage fees.
