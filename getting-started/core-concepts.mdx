...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of RepForce.ai, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of RepForce.ai. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- RepForce.ai integrates with **ElevenLabs** voices for natural-sounding speech.
