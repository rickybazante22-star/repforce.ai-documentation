...
icon: "book"
description: "Essential terms and concepts you need to know to use RepForce.ai effectively"
---

Understanding these terms will help you navigate RepForce.ai more easily:
...
RepForce.ai's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with RepForce.ai without renting new numbers.
