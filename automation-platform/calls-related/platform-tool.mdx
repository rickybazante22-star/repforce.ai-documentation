---
title: "RepForce.ai Tool"
icon: "phone"
description: "Learn how to use RepForce.ai triggers and actions in your AI calling flows"
---

# RepForce.ai Tool

The RepForce.ai tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the RepForce.ai tool prominently displayed at the top of the
...
![RepForce.ai Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![RepForce.ai Action](/resources/autocalls-action.jpg)
